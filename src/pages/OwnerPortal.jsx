        ...
        {selectedOwner && (
          <div className="space-y-7 animate-fade-in">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs dark:text-gray-400 text-gray-500 mt-1">
                    No. Handphone: <span className="font-mono font-medium">{selectedOwner.phone || '-'}</span>
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
              ...
              <div className="col-span-1 md:col-span-2 p-6 lg:p-7 rounded-3xl bg-gradient-to-br from-emerald-500/20 via-surface-200 to-surface-200 dark:border-emerald-500/30 border border-emerald-500/20 shadow-md flex flex-col justify-between">
                <div>
                ...
                <p className="text-xs dark:text-gray-400 text-gray-500 mt-4 leading-relaxed">
                  Total hak dari barang terjual dikurangi pencairan yang sudah ditransfer.
                </p>
              </div>

              {/* Total Hak Bersih Terjual */}
              <div className="p-6 lg:p-7 rounded-3xl dark:bg-surface-200 bg-white border dark:border-white/10 border-gray-200 shadow-sm flex flex-col justify-between">
                <div>
                  <span className="text-xs font-bold dark:text-gray-400 text-gray-500 uppercase tracking-wider block mb-3">
                ...
                <p className="text-xs font-semibold text-accent mt-4 flex items-center gap-1.5">
                  <span>✓</span>
                  <span>{stats.soldItems} barang sudah laku</span>
                </p>
              </div>
              ...
              <div className="p-6 lg:p-7 rounded-3xl dark:bg-surface-200 bg-white border dark:border-white/10 border-gray-200 shadow-sm flex flex-col justify-between">
                ...
                <p className="text-xs dark:text-gray-400 text-gray-500 mt-4 flex items-center gap-1.5">
                  <span>💳</span>
                  <span>{ownerWithdrawalsList.length} kali pencairan</span>
                </p>
              </div>
            </div>
